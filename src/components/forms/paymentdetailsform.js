...
function PaymentDetails({ formik, paymentDetails, setPaymentDetails, bookingDetails, setBookingDetails }) {
    ...
    return (
        <>
            ...
            <FormInput name='expiryDate' id='expiryDate' input='regular' type='text' label='Expiry Date' formik={formik} />
            <FormInput name='cvv' id='cvv' input='regular' type='text' label='CVV (MM/YY)' formik={formik} />
